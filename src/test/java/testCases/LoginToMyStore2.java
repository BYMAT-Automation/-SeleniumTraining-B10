...
public class LoginToMyStore2 extends TestBase_B10 {
	...
	public void loginToMyStore2(Hashtable<String, String> htData) throws InterruptedException, IOException {
		...
		CommonMethods.enterTextIntoTextBox("first_Name1", htData.get("First_Name"), "First Name");
